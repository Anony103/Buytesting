            ...
            <tbody>
                {data.map((value, index) => (
                    <tr key={index}>
                        ...
                        <td className="py-4 px-2 border-b-[1px] border-b-[#E8E8E8] text-[#161616] lg:text-[.6rem] windowScreen:text-sm font-Nunito font-light">{value.mobile}</td>
                        ...
                        <td className="py-4 px-2 border-b-[1px] border-b-[#E8E8E8] text-[#161616] lg:text-[.6rem] windowScreen:text-sm font-Nunito font-light">{value.status}</td>
                        <td className="py-4 px-2 border-b-[1px] border-b-[#E8E8E8] text-[#161616] lg:text-[.6rem] windowScreen:text-sm font-Nunito font-light">
                            <div className="flex lg:gap-2 windowScreen:gap-5 items-center">
                                <button
                                    ...
                                    title="View buyer"
                                    onClick={() => {
                                        navigate(gotoRoute, { state: value })
                                    }}
