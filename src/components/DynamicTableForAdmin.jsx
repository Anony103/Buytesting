...
const DynamicTableForAdmin = ({ data, tableIcon2, tableIcon3, showCheckbox, name, gotoRoute }) => {
            ...
            <tbody>
                {data.map((value, index) => (
                    <tr key={index}>
                        ...
                        <td className="py-4 px-2 border-b-[1px] border-b-[#E8E8E8] text-[#161616] lg:text-[.6rem] windowScreen:text-sm font-Nunito font-light">{value.status?'Enabled':'Flagged'}</td>
                        <td className="py-4 px-2 border-b-[1px] border-b-[#E8E8E8] text-[#161616] lg:text-[.6rem] windowScreen:text-sm font-Nunito font-light">
...
export default DynamicTableForAdmin;