...
const ForgotPassword = () => {
    ...
    return ( 
        <section className="w-full h-[100vh] bg-white lg:bg-authBg bg-no-repeat bg-cover lg:py-[5rem] flex justify-center lg:items-center font-Lexend">
            <div className="windowScreen:w-[36%] lg:w-[45%] xl:w-[35%] md:w-[80%] w-[95%] bg-[#FFF] py-[2rem] macScreens:py-[4rem] macScreens:pb-[7rem] lg:py-[3rem] macScreens:px-[4rem] lg:px-[4rem] rounded-[5px]">
