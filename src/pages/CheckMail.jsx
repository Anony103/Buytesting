...
const CheckMail = () => {
    ...
    return ( 
        <section className="w-full h-[100vh] bg-white lg:bg-authBg bg-no-repeat bg-cover lg:py-[5rem] flex justify-center items-center font-Lexend">
            <div className="windowScreen:w-[36%] lg:w-[45%] xl:w-[35%] w-[90%] bg-[#FFF] flex flex-col justify-center items-center macScreens:gap-[2rem] lg:gap-[1.2rem] windowScreen:gap-[1.5rem] gap-2 macScreens:py-[2.5rem] lg:py-[2rem] py-[3rem] macScreens:px-[4rem] lg:px-[4rem] rounded-[5px]">
