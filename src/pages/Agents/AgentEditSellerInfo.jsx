        ...
        <section className="overflow-x-hidden h-[100vh] w-full flex relative">
            <div className="w-[280px] shadow-md fixed h-[100vh]">
                ...
                <div className="w-full flex justify-center items h-[85%]">
                    <div className="tab-list w-full h-full flex flex-col gap-5 px-5 py-[4rem]">
                        <SidebarNavLink 
                        to="/agent/dashboard" 
                        icon={
            ...
            <div className="w-[calc(100%-280px)] ms-[280px]">
                ...
                <div className="w-full min-h-[calc(100%-5rem)] mt-[2rem] pt-[6rem] px-[2rem] flex flex-col gap-5 macScreens:px-10">
                    <BuyerPathBreadCrumb home="Seller's List" shop="> Edit Seller's Informations"/>
                    <div className="w-full flex justify-start items-center py-5">
                        <h1 className="font-semibold text-[#110D06] text-[1.5rem]">All seller</h1>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-7 w-full pb-[5rem]">
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                            <InputField label="First Name" name="first-name" placeholder="Enter your first name here..." type="text" required onChange={(e) => console.log(e)} />
                        </div>
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                            <InputField label="Last Name" name="last-name" placeholder="Enter your last name here..." type="text" required onChange={(e) => console.log(e)} />
                        </div>
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                        ...
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                            <InputField label="Business Name" name="business-name" placeholder="Enter your business name here..." type="text" required onChange={(e) => console.log(e)} />
                        </div>
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                            <InputField label="Business Phone Number" name="phone" placeholder="Enter your business phone number here..." type="tel" required onChange={(e) => console.log(e)} />
                        </div>
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                        ...
                        <div className="input-box flex flex-col gap-1 lg:gap-2 macScreens:gap-2  macScreens:text-[1rem] lg:text-[.8rem]">
                            <InputField label="City" name="City" placeholder="Enter your city" type="text" required onChange={(e) => console.log(e)} />
                        </div>
...
export default AgentEditSellerInfo;