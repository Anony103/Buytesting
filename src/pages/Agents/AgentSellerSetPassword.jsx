                ...
                <div className="windowScreen:w-[36%] lg:w-[45%] xl:w-[35%] w-[90%] bg-[#FBFBFB] shadow-lg py-[3rem] macScreens:py-[4rem] lg:py-[3rem] macScreens:px-[3rem] lg:px-[2rem] rounded-[5px]">
                    <form className="w-full flex flex-col items-center gap-10 lg:gap-10 text-[#000] px-1">
                        <div className="flex flex-col justify-center items-center">
                            <h1 className="font-semibold text-[1rem] md:text-[1.5rem] lg:text-[1.3rem] macScreens:text-[1.5rem]">Set A Password</h1>
                            <h3 className="font-light font-Nunito text-[.7rem] md:text-[1.2rem] lg:text-[.8rem] macScreens:text-[1rem]">Set a password for this seller and the seller</h3>
                            <h3 className="font-light font-Nunito text-[.7rem] md:text-[1.2rem] lg:text-[.8rem] macScreens:text-[1rem]">can change it as anytime</h3>
                        </div>
...
export default AgentSellerSetPassword;;