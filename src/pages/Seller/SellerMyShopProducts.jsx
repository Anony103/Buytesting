...
import SellerMyProductsComponent from "../../components/SellerMyProductsComponent";

const SellerMyShopProducts = () => {
    ...
    return ( 
        <section className="overflow-x-hidden w-full flex flex-col items-center macScreens:gap-5 lg:gap-3 gap-2">
            ...
            <VerticalTabs contentComponent={<SellerMyProductsComponent />} />
            <Footer />
        </section>
     );
}
 
export default SellerMyShopProducts;